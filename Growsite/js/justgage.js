...
JustGage = function(config) {
  ...
  obj.config = {
    ...
    // 'above' or 'below'
    titlePosition: kvLookup('titlePosition', config, dataset, "below"),
    ...
    humanFriendlyDecimal: kvLookup('humanFriendlyDecimal', config, dataset, 1),
    ...
    // shadowSize: int
    // inner shadow size
    shadowSize: kvLookup('shadowSize', config, dataset, 2),

    // shadowVerticalOffset : int
    // how much shadow is offset from top
    shadowVerticalOffset: kvLookup('shadowVerticalOffset', config, dataset, 5),
    ...
    startAnimationTime: kvLookup('startAnimationTime', config, dataset, 1500),
    ...
    // hide inner shadow
    hideInnerShadow: kvLookup('hideInnerShadow', config, dataset, true),
    ...
    formatNumber: kvLookup('formatNumber', config, dataset, true),
